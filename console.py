...
place_1 = Place("Kota Kinabalu","Mountain peak and nature reserve.", "Nature Reserve", country_1, True)
...
place_3=Place('Machu Picchu', "Ancient Inca City and mountain peak","Archaeological Site",country_2, True )
